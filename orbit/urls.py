...
from .views import AboutAPIView, AboutSkillAPIView, CategoryAPIView, PortfolioAPIView, WorkexAPIView, EducationAPIView, AwardsAPIView, HapclientsAPIView, ServiceAPIView, BlogPostAPIView, ContactAPIView
